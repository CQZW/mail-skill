---
name: mail
description: Use when Codex should register mailboxes, send or read mail, inspect mailbox state, or manage local fromaiagent mailbox profiles through MCP tools.
---
...
- If MCP tools are unavailable, stop and tell the developer to fix the MCP setup.
